...
const GioHangIcon = (props) => (
    <View style={[{ padding: 5 }, Platform.OS == 'ios' ? styles.iconContainer : null]}>
        <View style={{
        ...
        <Icon onPress={() => props.navigation.navigate('GioHangScreen')} name="cart" size={40} />
    </View>
)
...
export default connect(mapStateToProps)(withNavigation(GioHangIcon));
